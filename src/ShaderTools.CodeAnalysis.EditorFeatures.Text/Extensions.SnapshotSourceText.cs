        ...
        private class SnapshotSourceText : SourceText
        {
            ...
            internal sealed class ClosedSnapshotSourceText : SnapshotSourceText
            {
                public ClosedSnapshotSourceText(ITextSnapshot roslynSnapshot)
                    : base(roslynSnapshot, containerOpt: null)
                {
                }
            }
            ...
            /// </summary>
            public readonly ITextSnapshot EditorSnapshot;
            ...
            public override int Length
            {
                get
                {
                    var res = this.EditorSnapshot.Length;
                    return res;
                }
            }
            ...
            private class LineInfo : TextLineCollection
            {
                ...
                {
                    get { return _text.EditorSnapshot.LineCount; }
                }
                ...
                public override TextLine this[int index]
                {
                    get
                    {
                        var line = _text.EditorSnapshot.GetLineFromLineNumber(index);
                ...
                {
                    return _text.EditorSnapshot.GetLineNumberFromPosition(position);
                }
            ...
            {
                return this.EditorSnapshot.GetText();
            }
            ...
            {
                this.EditorSnapshot.CopyTo(sourceIndex, destination, destinationIndex, count);
            }

            public override void Write(TextWriter textWriter, TextSpan span, CancellationToken cancellationToken)
            {
                this.EditorSnapshot.Write(textWriter, span.ToSpan());
            }
