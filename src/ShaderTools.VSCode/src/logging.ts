...
export class Logger {
    ...
    constructor() {
        this.logChannel = vscode.window.createOutputChannel("ShaderTools Extension Logs");
    ...
    public startNewLog(minimumLogLevel: string = "Normal") {
        ...
        this.logFilePath = this.getLogFilePath("vscode-shadertools");
