...
namespace ShaderTools.Editor.VisualStudio.Hlsl.IntelliSense.QuickInfo
{
    ...
    {
        public static QuickInfoModel ForSymbol(SemanticModel semanticModel, SourceFileSpan span, Symbol symbol)
        {
        ...
        public static QuickInfoModel ForMacroDefinition(SemanticModel semanticModel, SourceFileSpan span, DefineDirectiveTriviaSyntax macroDefinition)
        {
        ...
        public static QuickInfoModel ForMacroReference(SemanticModel semanticModel, SourceFileSpan span, MacroReference macroReference)
        {
            var glyph = Glyph.Macro;
        ...
        private QuickInfoModel(SemanticModel semanticModel, SourceFileSpan span, Glyph glyph, SymbolMarkup markup, string documentation)
        {
