		    ...
		    ) : COLOR
{
    ...
    texCol = mul(texCol,wv) + (QUAD_REAL3)0.5;
...
> {
    ...
    > {
        ...
        SetPixelShader( CompileShader( ps_4_0, spinPS(gSceneSampler,gWorldViewXf) ) );
...
> {
	...
	VertexShader = compile vs_3_0 ScreenQuadVS2(QuadTexelOffsets);
		...
		CullMode = None;
	PixelShader = compile ps_3_0 spinPS(gSceneSampler,gWorldViewXf);
    }
}
