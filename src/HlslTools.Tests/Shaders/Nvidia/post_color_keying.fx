...
QUAD_REAL4 keyerPS(QuadVertexOutput IN,
...
> {
    ...
    > {
        ...
        SetPixelShader( CompileShader( ps_4_0, keyerPS(gSceneSampler) ) );
...
> {
	...
	VertexShader = compile vs_3_0 ScreenQuadVS2(QuadTexelOffsets);
		...
		CullMode = None;
	PixelShader = compile ps_3_0 keyerPS(gSceneSampler);
    }
}
