...
QUAD_REAL4 posterPS(QuadVertexOutput IN,
...
> {
    ...
    > {
        ...
        SetPixelShader( CompileShader( ps_4_0, posterPS(gSceneSampler,
					    gNColors,gGamma) ) );
...
> {
	...
	VertexShader = compile vs_3_0 ScreenQuadVS2(QuadTexelOffsets);
		...
		CullMode = None;
	PixelShader = compile ps_3_0 posterPS(gSceneSampler,
					    gNColors,gGamma);
    }
}
