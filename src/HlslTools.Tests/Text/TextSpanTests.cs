...
namespace HlslTools.Tests.Text
{
    ...
    public sealed class TextSpanTests
    {
        ...
        {
            var textSpan = TextSpan.FromBounds(null, 1, 3);
            Assert.AreEqual(1, textSpan.Start);
            Assert.AreEqual(2, textSpan.Length);
            Assert.AreEqual(3, textSpan.End);
        }
        ...
        {
            var textSpan1 = TextSpan.FromBounds(null, 2, 5);
            var textSpan2 = TextSpan.FromBounds(null, 3, 7);
        ...
        {
            var textSpan1 = TextSpan.FromBounds(null, 2, 8);
            var textSpan2 = TextSpan.FromBounds(null, 3, 6);
            Assert.True(textSpan1.OverlapsWith(textSpan2));
            Assert.True(textSpan2.OverlapsWith(textSpan1));
        }
        ...
        {
            var textSpan1 = TextSpan.FromBounds(null, 1, 2);
            var textSpan2 = TextSpan.FromBounds(null, 2, 3);
        ...
        {
            var textSpan1 = new TextSpan(null, 1, 2);
        ...
        {
            var textSpan1 = new TextSpan(null, 1, 2);
            var textSpan2 = new TextSpan(null, 2, 3);
