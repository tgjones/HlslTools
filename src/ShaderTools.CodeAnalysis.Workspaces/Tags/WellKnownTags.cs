...
namespace ShaderTools.CodeAnalysis.Tags
{
    ...
    internal static class WellKnownTagArrays
    {
        ...
        internal static readonly ImmutableArray<string> HlslFile = ImmutableArray.Create(WellKnownTags.File, LanguageNames.Hlsl);
        internal static readonly ImmutableArray<string> ShaderLabFile = ImmutableArray.Create(WellKnownTags.File, LanguageNames.ShaderLab);
    }
}