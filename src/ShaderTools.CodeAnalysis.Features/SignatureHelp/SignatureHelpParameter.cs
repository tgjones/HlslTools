...
namespace ShaderTools.CodeAnalysis.SignatureHelp
{
    ...
    internal class SignatureHelpSymbolParameter
    {
        ...
        /// </summary>
        public IList<SymbolMarkupToken> SelectedDisplayParts { get; }
        ...
        public SignatureHelpSymbolParameter(
            ...
            IEnumerable<SymbolMarkupToken> displayParts,
            IEnumerable<SymbolMarkupToken> prefixDisplayParts = null,
            IEnumerable<SymbolMarkupToken> suffixDisplayParts = null,
            IEnumerable<SymbolMarkupToken> selectedDisplayParts = null)
        {
        ...
        internal IEnumerable<SymbolMarkupToken> GetAllParts()
        {
