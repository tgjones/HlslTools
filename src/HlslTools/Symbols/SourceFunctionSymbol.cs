...
namespace HlslTools.Symbols
{
    ...
    {
        public SourceFunctionSymbol(FunctionDeclarationSyntax syntax, TypeSymbol returnType, Func<FunctionSymbol, IEnumerable<ParameterSymbol>> lazyParameters)
            : base(syntax.Name.Text, string.Empty, returnType, lazyParameters)
        {
            DeclarationSyntax = syntax;
        }

        public SourceFunctionSymbol(FunctionDefinitionSyntax syntax, TypeSymbol returnType, Func<FunctionSymbol, IEnumerable<ParameterSymbol>> lazyParameters)
