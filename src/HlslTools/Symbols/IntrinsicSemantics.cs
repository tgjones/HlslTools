...
namespace HlslTools.Symbols
{
    internal static class IntrinsicSemantics
    {
        ...
        static IntrinsicSemantics()
        {
            ...
            allSemantics.Add(new SemanticSymbol("SV_Target", "The output value that will be stored in a render target. The index indicates which of the 8 possibly bound render targets to write to.", true, SemanticUsages.PixelShaderInput, IntrinsicTypes.Float));
