...
> {
    ...
    > {
        ...
        SetPixelShader( CompileShader( ps_4_0, glossPS(gSurfaceColor,
...
> {
    ...
    > {
		...
		CullMode = None;
        PixelShader = compile ps_3_0 glossPS(gSurfaceColor,
			gKs,gSpecExpon,gSpecColor,
			gGlossTopUI,gGlossBotUI,gGlossDrop,gAmbiColor);
    }
}
...
> {
    ...
    > {
        SetVertexShader( CompileShader( vs_4_0, std_VS(gWorldITXf,gWorldXf,
				...
				gLamp0Pos) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, glossPS_t(gSurfaceColor,gColorSampler,
			gKs,gSpecExpon,gSpecColor,
			gGlossTopUI,gGlossBotUI,gGlossDrop,gAmbiColor) ) );
	    SetRasterizerState(DisableCulling);
	    SetDepthStencilState(DepthEnabling, 0);
...
> {
    ...
    > {
		...
		AlphaBlendEnable = false;
		CullMode = None;
        PixelShader = compile ps_3_0 glossPS_t(gSurfaceColor,gColorSampler,
			gKs,gSpecExpon,gSpecColor,
			gGlossTopUI,gGlossBotUI,gGlossDrop,gAmbiColor);
    }
}
