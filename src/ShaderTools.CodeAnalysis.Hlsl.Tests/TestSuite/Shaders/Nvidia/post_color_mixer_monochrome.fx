...
static QUAD_REAL4 mixer = QUAD_REAL4(Red,Green,Blue,Alpha);
QUAD_REAL4 monoMixPS(QuadVertexOutput IN,
...
> {
    ...
    > {
        ...
        SetPixelShader( CompileShader( ps_4_0, monoMixPS(gSceneSampler) ) );
...
> {
	...
	VertexShader = compile vs_3_0 ScreenQuadVS2(QuadTexelOffsets);
		...
		CullMode = None;
	PixelShader = compile ps_3_0 monoMixPS(gSceneSampler);
    }
}
