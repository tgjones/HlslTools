...
using ShaderTools.VisualStudio.LanguageServices.NavigationBar;
...
namespace ShaderTools.VisualStudio.LanguageServices.LanguageService
{
    internal abstract partial class AbstractLanguageService<TPackage, TLanguageService>
    {
        internal class VsCodeWindowManager : IVsCodeWindowManager, IVsCodeWindowEvents
        {
            ...
            {
                if (e.Language != _languageService.ShaderToolsLanguageName ||
                    e.Option != NavigationBarOptions.ShowNavigationBar)
                {
                    return;
                }

                var enabled = _optionService.GetOption(NavigationBarOptions.ShowNavigationBar, _languageService.ShaderToolsLanguageName);
            ...
            private void AdddropdownBar(IVsDropdownBarManager dropdownManager)
            {
                ...
                var navigationBarClient = new NavigationBarClient(dropdownManager, _codeWindow, _languageService.SystemServiceProvider);
